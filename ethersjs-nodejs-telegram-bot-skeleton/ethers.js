...
module.exports.getToken = async () => {
      ...
      // You can also use an ENS name for the contract address
          const felixAddress = '0x54366D719dE364249bEd203115cc116ef8d4DD8f';
  ...
  },
  {
    ...
    "name": "RemoveAutomatedMarketMakerPair",
    "type": "event"
  },
  {
    "anonymous": false,
  ...
  },
  {
    ...
    "name": "adjustDistributionCriteria",
    "outputs": [],
  ...
  },
  {
    ...
    "name": "getUndeliveredReflections",
    "outputs": [
      {
        "internalType": "uint256",
        "name": "",
  ...
  {
    "inputs": [],
    "name": "reflectionsPerShareAccuracyFactor",
    "outputs": [
      {
        "internalType": "uint256",
        "name": "",
  ...
  },
  {
    ...
    "outputs": [
      {
        "internalType": "contract IREFLECT",
        "name": "",
        "type": "address"
      }
    ],
  ...
  },
  {
    "inputs": [
      ...
      {
        "internalType": "address payable",
        "name": "_teamDonationsReceiver",
        "type": "address"
      }
    ],
    "name": "setDonationReceivers",
    "outputs": [],
    "stateMutability": "nonpayable",
    "type": "function"
  },
  ...
  },
  {
    "inputs": [
      {
        "internalType": "uint256",
        "name": "_liquidityDonations",
        "type": "uint256"
      },
      {
        "internalType": "uint256",
        "name": "_buybackDonations",
        "type": "uint256"
      },
      {
        "internalType": "uint256",
        "name": "_reflectionDonations",
        "type": "uint256"
      },
      {
        "internalType": "uint256",
  ...
  },
  {
    ...
    "type": "receive"
          ...
          // The Contract object
          const felixContract = new ethers.Contract(felixAddress, felixAbi, provider);
          // Get the ERC-20 token name
          // console.log(await felixContract.name());
          // 'felix Stablecoin'

          // Get the ERC-20 token symbol (for tickers and UIs)
          // console.log(await felixContract.symbol());
          // 'felix'

          // Get the balance of an address "ricmoo.firefly.eth"
          // block_type = await felixContract.getLastBlockTimeType();
          //document.getElementById("wallet_contract_balance").innerHTML = ethers.utils.formatUnits(balance, 18);
          //  gasPrice

          let theResult = await felixContract.getBlockMode();
